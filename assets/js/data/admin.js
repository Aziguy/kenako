/**
 * Kenako — console superadmin (pilotage de la plateforme)
 * Rappel structurant : la plateforme ne touche jamais l'argent des commandes.
 * Le volume de commandes n'est affiché qu'à titre indicatif, et aucune action
 * n'est possible sur une commande depuis cet espace.
 */

export const ADMIN_KPI = {
  mrr: 18470, mrrPrev: 17240,
  active: 214, pending: 9, suspended: 6,
  trialConv: 61, trialConvPrev: 57,
  churn: 2.4, churnPrev: 2.9,
  orders30: 18420,
  signups: 17, signupsPrev: 13,
};

export const MRR_12 = [9800, 10600, 11250, 12100, 12800, 13600, 14350, 15200, 15900, 16700, 17240, 18470];
export const MRR_MONTHS = ['oct.', 'nov.', 'déc.', 'janv.', 'févr.', 'mars', 'avr.', 'mai', 'juin', 'juil.', 'août', 'sept.'];

export const CITIES = [
  { name: 'Paris', restos: 118, lat: 48.8566, lng: 2.3522, mrr: 9820 },
  { name: 'Lyon', restos: 34, lat: 45.764, lng: 4.8357, mrr: 2870 },
...
export const ADMIN_PLANS = [
  { name: 'Essentiel', monthly: 29, yearly: 290, subs: 96, color: '#157A5B', features: ['Boutique en ligne', 'Commandes illimitées', 'Carte + espèces', '1 compte staff'], limits: '1 établissement · 50 plats' },
  { name: 'Signature', monthly: 79, yearly: 790, subs: 92, color: '#C9451A', features: ['Tout Essentiel', 'Livreurs internes', 'Fidélité & parrainage', 'Campagnes email / SMS', '10 comptes staff'], limits: '1 établissement · plats illimités' },
  { name: 'Maison', monthly: 149, yearly: 1490, subs: 26, color: '#F5A524', features: ['Tout Signature', 'Multi-établissements', 'API & caisse', 'Support prioritaire'], limits: '5 établissements · illimité' },
];

export const SUB_PROMOS = [
...
export const CMS = {
  hero: {
    title: 'Les bonnes tables de votre quartier, sans commission',
    subtitle: 'Commandez directement auprès de restaurants indépendants. Ce que vous payez leur revient.',
    cta: 'Découvrir les restaurants',
    visual: 'Photo · table dressée en terrasse',
  },
  blocks: [
...
export const CUISINE_CATS = ['Bistrot', 'Pizzeria', 'Libanais', 'Japonais', 'Burger', 'Ouest-africain', 'Végétarien', 'Brasserie', 'Vietnamien', 'Mexicain', 'Indien', 'Coréen'];

export const COVERED_CITIES = [
  { name: 'Paris', restos: 118, on: true }, { name: 'Lyon', restos: 34, on: true },
  { name: 'Marseille', restos: 21, on: true }, { name: 'Bordeaux', restos: 16, on: true },
  { name: 'Lille', restos: 12, on: true }, { name: 'Nantes', restos: 9, on: true },
  { name: 'Toulouse', restos: 4, on: true }, { name: 'Strasbourg', restos: 0, on: false },
  { name: 'Rennes', restos: 0, on: false },
];
...
export const PLATFORM_ORDERS = [
  ...
  { id: 'K-48226', resto: 'Le Comptoir de Marie', client: 'Table 7', mode: 'Sur place', status: 'En préparation', total: 79, time: '11:48' },
...
export const AUDIT = [
  ...
  { who: 'Sonia (superadmin)', what: 'Création de la promotion LANCEMENT3M', when: '1er sept. 09:14' },
];
...
export const ADMIN_ROLE_RIGHTS = {
  Superadmin: ['Tous les droits', 'Gestion des administrateurs'],
  Support: ['Tickets', 'Impersonation', 'Lecture seule des commandes'],
  Facturation: ['Abonnements', 'Factures', 'Relances'],
  Modération: ['Avis signalés', 'Journal d’audit'],
};
